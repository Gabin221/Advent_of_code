...
def j7():
    ...
    hand_types = { "Five of a kind" : [],       # exemple : 55555 
                "Four of a kind" : [],     # exemple : 5555A 
                "Full house" : [],         # exemple : 555AA 
                "Trois d'un genre" : [],    # exemple : 555AK 
                "Deux paires" : [],           # exemple : 55AAK 
                "Une paire" : [],           # exemple : 55AKQ 
                "Carte haute" : []}          # exemple : 5AKQJ
    ...
    def partie1():
        ...
        strength = "AKQJT98765432""AKQJT98765432"
        ...
        print(f"Réponse jour 7 partie 1 : {total}")
    ...
    def partie2():
        ...
        for i, pair in enumerate(final_list):
            total += (i + 1) * int(pairs_dict[pair])
        print(f"Réponse jour 7 partie 2 : {total}")
